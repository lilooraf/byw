...
import { Country, Fixture, League, Prisma, Team, Venue, Standing } from "@prisma/client";
...
const H2H: React.FC<{ fixtures: Fixture[], homeId: number, awayId: number }> = ({ fixtures, homeId, awayId }) => {
  ...
  if (homeWins! && awayWins! && draws!) {
    ...
    return (
      <div className="bg-gray-800 text-xs text-yellow-500 rounded-md my-2 py-1 grid grid-cols-3 grid-rows-1 text-center">
        <small>{homeWins} VICTOIRE{homeWins > 1 ? 'S' : ''}</small>
        <small>{draws} NULL{draws > 1 ? 'S' : ''}</small>
        <small>{awayWins} VICTOIRE{awayWins > 1 ? 'S' : ''}</small>
      </div>
    )
  }
}

const Span: React.FC<{ fixture: Fixture, teamId: number }> = ({ fixture, teamId }) => {
  if (!fixture || fixture.date > new Date()) {
    return (<span className="flex justify-center items-center rounded-full bg-slate-400 h-4 w-4 text-sm text-slate-800">
      <small>X</small>
    </span>
    )
  }
  if ((fixture?.winnerHome && fixture?.teamHomeId === teamId) || (fixture?.winnerAway && fixture?.teamAwayId === teamId)) {
    return (
      <span className="flex justify-center items-center rounded-full bg-green-600 h-4 w-4 text-sm text-slate-800">
        <small>V</small>
      </span>
    );
  } else if ((fixture?.winnerAway && fixture?.teamHomeId === teamId) || (fixture?.winnerHome && fixture?.teamAwayId === teamId)) {
    return (
  ...
  return (
    ...
    <tr className="rounded-sm border-b-2 border-gray-200">
      ...
      <td>
        <table className="flex w-full justify-between my-2">
          <td>
            ...
            <div className="flex items-center space-x-2">
              <div className="flex-grow flex space-x-1 justify-end">
                <Span fixture={fixture.TeamHome.Fixtures[0]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.Fixtures[1]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.Fixtures[2]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.Fixtures[3]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.Fixtures[4]} teamId={fixture.TeamHome.id} ></Span>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex-grow flex space-x-1 justify-end">
                <Span fixture={fixture.TeamHome.FixturesHome[0]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.FixturesHome[1]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.FixturesHome[2]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.FixturesHome[3]} teamId={fixture.TeamHome.id} ></Span>
                <Span fixture={fixture.TeamHome.FixturesHome[4]} teamId={fixture.TeamHome.id} ></Span>
                <span className="flex justify-center items-center rounded-sm border-2 border-green-600 h-4 w-10 text-sm">
                  <small className="">13 pts</small>
                </span>
              </div>
          ...
          <td>
            <div className="flex items-center space-x-1 justify-start mb-2">
              ...
              />
              {/* TODO get just the standing of the team by leagueId */}
              <p>{`(${fixture.TeamAway.Standing[0].rank}) ${fixture.TeamAway.name}`}</p>
            </div>
            <div className="flex items-center space-x-2">
              <div className="flex-grow flex space-x-1 justify-end">
                <Span fixture={fixture.TeamAway.Fixtures[0]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.Fixtures[1]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.Fixtures[2]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.Fixtures[3]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.Fixtures[4]} teamId={fixture.TeamAway.id} ></Span>
                <span className="flex justify-center items-center rounded-sm border-2 border-green-600 h-4 w-10 text-sm">
                  <small className="">13 pts</small>
                </span>
              </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex-grow flex space-x-1 justify-end">
                <Span fixture={fixture.TeamAway.FixturesAway[0]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.FixturesAway[1]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.FixturesAway[2]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.FixturesAway[3]} teamId={fixture.TeamAway.id} ></Span>
                <Span fixture={fixture.TeamAway.FixturesAway[4]} teamId={fixture.TeamHome.id} ></Span>
                <span className="flex justify-center items-center rounded-sm border-2 border-green-600 h-4 w-10 text-sm">
                  <small className="">13 pts</small>
                </span>
              </div>
        ...
        <H2H fixtures={fixture.TeamHome.Fixtures} homeId={fixture.TeamHome.id} awayId={fixture.TeamAway.id} />
      </td>
